    ...
    return(
        <div className="product-container">
            <img className="product-img" src="https://i5.walmartimages.com/asr/df0c9808-7b30-4a5c-adf8-a1868304756f.48fb5e187bf4b965a69465d8520f88fe.jpeg?odnHeight=612&odnWidth=612&odnBg=FFFFFF" alt="Product" />
                ...
                <p className="mobile-regular desktop-regular">Toleriane Hydrating Gentle Cleanser is a daily face wash for normal to dry, sensitive skin. Formulated with La Roche-Posay prebiotic thermal ....</p>
                </div>
                ...
                <div className="reviews-section">
                    ...
                    <div className="review">
                        <div className="review-rating">
                            <p className="mobile-subheading">Anonymous</p>
                            <span>5 days ago</span>
                        </div>
                        <span>⭐⭐⭐⭐⭐</span>
                        <p className="bold">Skin Type: Oily, Sensitive</p>
